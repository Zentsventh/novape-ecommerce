    ...
    return (
        <AdminLayout logoUrl={null}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                <h1 style={{ fontSize: '24px', fontWeight: 'bold', color: 'var(--admin-text-main)' }}>Crear Nuevo Usuario</h1>
            ...
            <div style={{ background: 'var(--admin-bg-panel)', borderRadius: '12px', padding: '30px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)', maxWidth: '800px' }}>
                <form onSubmit={submit} style={{ display: 'grid', gap: '20px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px' }}>
                        ...
                        <div>
                            <label style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold', color: 'var(--admin-text-main)' }}>Contraseña *</label>
                            <input
                                type="password"
                                value={data.password}
                                ...
                                required
                            />
                            {errors.password && <div style={{ color: '#3b82f6', fontSize: '12px', marginTop: '4px' }}>{errors.password}</div>}
                        </div>
                    </div>
