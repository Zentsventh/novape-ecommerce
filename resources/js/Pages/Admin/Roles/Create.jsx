    ...
    return (
        <AdminLayout logoUrl={null}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                <h1 style={{ fontSize: '24px', fontWeight: 'bold', color: 'var(--admin-text-main)' }}>Crear Nuevo Rol</h1>
                ...
                <form onSubmit={submit} style={{ display: 'grid', gap: '20px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '20px' }}>
                        <div>
                            ...
                            />
                            <small style={{ color: 'var(--admin-text-muted)', display: 'block', marginTop: '4px' }}>Este nombre se usará internamente en el sistema. Preferible usar minúsculas y sin espacios.</small>
